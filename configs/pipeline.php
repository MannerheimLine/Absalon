...
$app->pipe('/cards',\Absalon\Application\PatientCard\Card\Middleware\CardValidatorMiddleware::class);
$app->pipe('/cards',\Absalon\Application\PatientCard\Card\Middleware\CardCreateMiddleware::class);
$app->pipe('/cards',\Absalon\Application\PatientCard\Card\Middleware\CardUpdateMiddleware::class);
