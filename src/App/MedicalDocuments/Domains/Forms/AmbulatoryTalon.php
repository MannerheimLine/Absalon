...
class AmbulatoryTalon extends MedicalForm
{
    ...
    protected string $_template = 'src/App/MedicalDocuments/Templates/ambulatory.talon.php';
    protected string $_stylesheet = 'src/App/MedicalDocuments/Templates/css/ambulatory.talon.css';
