...
class DentistTalon extends MedicalForm
{
    ...
    protected string $_template = 'src/App/MedicalDocuments/Templates/dentist.talon.php';
    protected string $_stylesheet = 'src/App/MedicalDocuments/Templates/css/dentist.talon.css';
