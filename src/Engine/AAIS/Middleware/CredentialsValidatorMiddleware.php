...
use Absalon\Engine\AAIS\Domains\Authentication\AuthErrors;
use Absalon\Engine\AAIS\Domains\Authentication\Credentials;
...
class CredentialsValidatorMiddleware implements MiddlewareInterface
{
    ...
    public function process(ServerRequestInterface $request, RequestHandlerInterface $handler): ResponseInterface
    {
        ...
        if ($this->_errors->hasErrors()) {
            return new JsonResponse($this->_errors, 401);
        }
